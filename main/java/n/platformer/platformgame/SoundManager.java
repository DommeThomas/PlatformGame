/*
    Erzeugt den Sound.
    Nähere Erläuterungen zur Sounderzeugung mit SoundPool usw.:
    1.) Buch "Android Game Programming by Example", S. 82ff
    2.) Buch "Learning Java by Building Android Games", S. 167ff
 */
...
public class SoundManager {
    ...
    // Referenzvariablen für die Sounds:
    int shoot = -1;
    int jump = -1;
    int teleport = -1;
    int coin_pickup = -1;
    ...
    public void loadSound(Context context) {
        // Loads all the sounds into memory ready for playing. We will call this once we have
        // initialized a SoundManager object in the PlatformView constructor.
    ...
    public void playSound(String sound) {
        // Spielt den Sound ab, dessen Name im String-Parameter sound steht:
        switch (sound) {
            case "shoot":
